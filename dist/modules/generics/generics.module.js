...
exports.GenericsModule = GenericsModule = __decorate([
    (0, common_1.Module)({
        controllers: [generics_controller_1.GenericsController],
        providers: [generics_service_1.GenericsService, prisma_service_1.PrismaService],
        exports: [generics_service_1.GenericsService],
    })
], GenericsModule);
